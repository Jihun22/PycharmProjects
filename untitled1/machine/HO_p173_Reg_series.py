...
elastic_net.fit(X, y)
predicted_value = elastic_net.predict([[1.5]])
print('\n\nelastic predicted_value([[1.5]] =\n{}\n\n'.format(predicted_value))
...
petal_length_1 = 1.7
petal_length_2 = 1.5
print('\nPredictions of prtal lengths ={}\n\n'.format(log_reg.predict([[petal_length_1], [petal_length_2]])))
...
print('\nsoftmax_reg.predict_prob([[5, 2]]={}\n\n'.format(softmax_reg.predict_proba([[5,2]])))
